...
struct BuildCertificateDeleteCommand: AuthenticatedCommand {
    ...
    func run() throws {
        let request = Bitrise.BuildCertificate.BuildCertificateDelete.Request(appSlug: appSlug, buildCertificateSlug: buildCertificateSlug)
