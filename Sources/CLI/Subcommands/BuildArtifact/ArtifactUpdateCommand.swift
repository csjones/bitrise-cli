...
struct ArtifactUpdateCommand: AuthenticatedCommand {
    ...
    @Argument var body: V0ArtifactUpdateArguments

    func run() throws {
        let request = Bitrise.BuildArtifact.ArtifactUpdate.Request(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug, body: body.data!)
