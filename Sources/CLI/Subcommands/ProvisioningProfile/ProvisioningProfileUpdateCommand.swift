...
struct ProvisioningProfileUpdateCommand: AuthenticatedCommand {
    ...
    @Argument var body: V0ProvProfileDocumentUpdateArguments

    func run() throws {
        let request = Bitrise.ProvisioningProfile.ProvisioningProfileUpdate.Request(appSlug: appSlug, provisioningProfileSlug: provisioningProfileSlug, body: body.data!)
