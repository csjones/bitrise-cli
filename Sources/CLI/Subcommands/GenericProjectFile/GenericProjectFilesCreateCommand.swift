...
struct GenericProjectFilesCreateCommand: AuthenticatedCommand {
    ...
    @Argument var body: V0ProjectFileStorageUploadArguments

    func run() throws {
        let request = Bitrise.GenericProjectFile.GenericProjectFilesCreate.Request(appSlug: appSlug, body: body.data!)
