...
struct AppListByUserCommand: AuthenticatedCommand {
    ...
    @Option var sortBy: Bitrise.Application.AppListByUser.SortBy?
    @Option var next: String?
    @Option var limit: Int?

    func run() throws {
        let request = Bitrise.Application.AppListByUser.Request(userSlug: userSlug, sortBy: sortBy, next: next, limit: limit)
...
extension Bitrise.Application.AppListByUser.SortBy: ExpressibleByArgument { }
