...
struct ArtifactShowCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.BuildArtifact.ArtifactShow.Request(appSlug: appSlug, buildSlug: buildSlug, artifactSlug: artifactSlug))
//            .await()
            .waitUntilDone()
    }
}