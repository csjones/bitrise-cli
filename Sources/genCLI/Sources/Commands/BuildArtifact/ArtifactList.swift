...
struct ArtifactListCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.BuildArtifact.ArtifactList.Request(appSlug: appSlug, buildSlug: buildSlug, next: next, limit: limit))
//            .await()
            .waitUntilDone()
    }
}