...
struct GenericProjectFileDeleteCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.GenericProjectFile.GenericProjectFileDelete.Request(appSlug: appSlug, genericProjectFileSlug: genericProjectFileSlug))
//            .await()
            .waitUntilDone()
    }
}