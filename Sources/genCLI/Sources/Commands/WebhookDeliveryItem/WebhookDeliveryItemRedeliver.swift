...
struct WebhookDeliveryItemRedeliverCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.WebhookDeliveryItem.WebhookDeliveryItemRedeliver.Request(appSlug: appSlug, appWebhookSlug: appWebhookSlug, webhookDeliveryItemSlug: webhookDeliveryItemSlug))
//            .await()
            .waitUntilDone()
    }
}