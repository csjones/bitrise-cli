...
struct WebhookDeliveryItemShowCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.WebhookDeliveryItem.WebhookDeliveryItemShow.Request(appSlug: appSlug, appWebhookSlug: appWebhookSlug, webhookDeliveryItemSlug: webhookDeliveryItemSlug))
//            .await()
            .waitUntilDone()
    }
}