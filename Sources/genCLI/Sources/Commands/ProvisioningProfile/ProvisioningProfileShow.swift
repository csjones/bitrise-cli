...
struct ProvisioningProfileShowCommand: AuthenticatedClientCommand {
    ...
    func run() throws {
        client
            .call(API.ProvisioningProfile.ProvisioningProfileShow.Request(appSlug: appSlug, provisioningProfileSlug: provisioningProfileSlug))
//            .await()
            .waitUntilDone()
    }
}