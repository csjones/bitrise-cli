...
public class V0AppListResponseModel: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? V0AppListResponseModel else { return false }
      guard self.data == object.data else { return false }
      guard self.paging == object.paging else { return false }
      return true
    }

    public static func == (lhs: V0AppListResponseModel, rhs: V0AppListResponseModel) -> Bool {
