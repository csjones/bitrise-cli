...
public class V0ActivityEventListResponseModel: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? V0ActivityEventListResponseModel else { return false }
      guard self.data == object.data else { return false }
      guard self.paging == object.paging else { return false }
      return true
    }

    public static func == (lhs: V0ActivityEventListResponseModel, rhs: V0ActivityEventListResponseModel) -> Bool {
