...
public class V0ArtifactListResponseModel: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? V0ArtifactListResponseModel else { return false }
      guard self.data == object.data else { return false }
      guard self.paging == object.paging else { return false }
      return true
    }

    public static func == (lhs: V0ArtifactListResponseModel, rhs: V0ArtifactListResponseModel) -> Bool {
