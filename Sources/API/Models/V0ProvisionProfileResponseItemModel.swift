...
public class V0ProvisionProfileResponseItemModel: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? V0ProvisionProfileResponseItemModel else { return false }
    ...
    public static func == (lhs: V0ProvisionProfileResponseItemModel, rhs: V0ProvisionProfileResponseItemModel) -> Bool {
