...
extension Bitrise.GenericProjectFile {
    ...
    */
    public enum GenericProjectFileShow {
        ...
        public static let service = APIService<Response>(id: "generic-project-file-show", tag: "generic-project-file", method: "GET", path: "/apps/{app-slug}/generic-project-files/{generic-project-file-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: GenericProjectFileShow.service)
            }
