...
extension Bitrise.Addons {
    ...
    */
    public enum AddonsList {
        ...
        public static let service = APIService<Response>(id: "addons-list", tag: "addons", method: "GET", path: "/addons", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: AddonsList.service)
            }
        }

        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0AddonsListResponseModel

            /** OK */
            case status200(V0AddonsListResponseModel)
            ...
            public var success: V0AddonsListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AddonsListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AddonsListResponseModel.self, from: data))
