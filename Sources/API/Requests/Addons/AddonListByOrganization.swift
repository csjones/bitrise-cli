...
extension Bitrise.Addons {
    ...
    */
    public enum AddonListByOrganization {
        ...
        public static let service = APIService<Response>(id: "addon-list-by-organization", tag: "addons", method: "GET", path: "/organizations/{organization-slug}/addons", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AddonListByOrganization.service)
            }
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "organization-slug" + "}", with: "\(self.options.organizationSlug)")
            }
        }

        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0OwnerAddOnsListResponseModel

            /** OK */
            case status200(V0OwnerAddOnsListResponseModel)
            ...
            public var success: V0OwnerAddOnsListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0OwnerAddOnsListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0OwnerAddOnsListResponseModel.self, from: data))
