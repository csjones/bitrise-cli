...
extension Bitrise.Addons {
    ...
    */
    public enum AddonListByApp {
        ...
        public static let service = APIService<Response>(id: "addon-list-by-app", tag: "addons", method: "GET", path: "/apps/{app-slug}/addons", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AddonListByApp.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0AppAddOnsListResponseModel

            /** OK */
            case status200(V0AppAddOnsListResponseModel)
            ...
            public var success: V0AppAddOnsListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppAddOnsListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppAddOnsListResponseModel.self, from: data))
