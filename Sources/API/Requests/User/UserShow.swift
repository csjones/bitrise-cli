...
extension Bitrise.User {
    ...
    */
    public enum UserShow {
        ...
        public static let service = APIService<Response>(id: "user-show", tag: "user", method: "GET", path: "/users/{user-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: UserShow.service)
            }
