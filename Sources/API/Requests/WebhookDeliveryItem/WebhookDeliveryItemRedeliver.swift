...
extension Bitrise.WebhookDeliveryItem {
    ...
    */
    public enum WebhookDeliveryItemRedeliver {
        ...
        public static let service = APIService<Response>(id: "webhook-delivery-item-redeliver", tag: "webhook-delivery-item", method: "POST", path: "/apps/{app-slug}/outgoing-webhooks/{app-webhook-slug}/delivery-items/{webhook-delivery-item-slug}/redeliver", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: WebhookDeliveryItemRedeliver.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(ServiceStandardErrorRespModel)
            ...
            public var success: ServiceStandardErrorRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<ServiceStandardErrorRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(ServiceStandardErrorRespModel.self, from: data))
