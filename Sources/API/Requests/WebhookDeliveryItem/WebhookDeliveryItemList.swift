    ...
    */
    public enum WebhookDeliveryItemList {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0WebhookDeliveryItemShowResponseModel)
            ...
            public var success: V0WebhookDeliveryItemShowResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0WebhookDeliveryItemShowResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0WebhookDeliveryItemShowResponseModel.self, from: data))
