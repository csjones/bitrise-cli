...
extension Bitrise.Activity {
    ...
    */
    public enum ActivityList {
        ...
        public static let service = APIService<Response>(id: "activity-list", tag: "activity", method: "GET", path: "/me/activities", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(next: String? = nil, limit: Int? = nil) {
                    self.next = next
                    self.limit = limit
                }
            }
            ...
            public init(options: Options) {
                ...
                super.init(service: ActivityList.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(next: String? = nil, limit: Int? = nil) {
                let options = Options(next: next, limit: limit)
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0ActivityEventListResponseModel

            /** OK */
            case status200(V0ActivityEventListResponseModel)
            ...
            public var success: V0ActivityEventListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0ActivityEventListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0ActivityEventListResponseModel.self, from: data))
