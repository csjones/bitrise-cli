...
extension Bitrise.ProvisioningProfile {
    ...
    */
    public enum ProvisioningProfileCreate {
        ...
        public static let service = APIService<Response>(id: "provisioning-profile-create", tag: "provisioning-profile", method: "POST", path: "/apps/{app-slug}/provisioning-profiles", hasBody: true, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0ProvisionProfileUploadParams) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Created */
            case status201(V0ProvisionProfileResponseModel)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(V0ProvisionProfileResponseModel.self, from: data))
