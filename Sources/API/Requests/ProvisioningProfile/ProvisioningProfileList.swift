...
extension Bitrise.ProvisioningProfile {
    ...
    */
    public enum ProvisioningProfileList {
        ...
        public static let service = APIService<Response>(id: "provisioning-profile-list", tag: "provisioning-profile", method: "GET", path: "/apps/{app-slug}/provisioning-profiles", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProvisioningProfileList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0ProvisionProfileListResponseModel

            /** OK */
            case status200(V0ProvisionProfileListResponseModel)
            ...
            public var success: V0ProvisionProfileListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0ProvisionProfileListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0ProvisionProfileListResponseModel.self, from: data))
