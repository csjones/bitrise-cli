...
extension Bitrise.ProvisioningProfile {
    ...
    */
    public enum ProvisioningProfileShow {
        ...
        public static let service = APIService<Response>(id: "provisioning-profile-show", tag: "provisioning-profile", method: "GET", path: "/apps/{app-slug}/provisioning-profiles/{provisioning-profile-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProvisioningProfileShow.service)
            }
