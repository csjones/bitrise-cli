...
extension Bitrise.ProvisioningProfile {
    ...
    */
    public enum ProvisioningProfileConfirm {
        ...
        public static let service = APIService<Response>(id: "provisioning-profile-confirm", tag: "provisioning-profile", method: "POST", path: "/apps/{app-slug}/provisioning-profiles/{provisioning-profile-slug}/uploaded", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: ProvisioningProfileConfirm.service)
            }
