...
extension Bitrise.Organizations {
    ...
    */
    public enum OrgShow {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0OrganizationRespModel

            /** OK */
            case status200(V0OrganizationRespModel)
            ...
            public var success: V0OrganizationRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0OrganizationRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0OrganizationRespModel.self, from: data))
