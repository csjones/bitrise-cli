...
extension Bitrise.Application {
    ...
    */
    public enum BranchList {
        ...
        public static let service = APIService<Response>(id: "branch-list", tag: "application", method: "GET", path: "/apps/{app-slug}/branches", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BranchList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0BranchListResponseModel

            /** OK */
            case status200(V0BranchListResponseModel)
            ...
            public var success: V0BranchListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BranchListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BranchListResponseModel.self, from: data))
