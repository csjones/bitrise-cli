...
extension Bitrise.Application {
    ...
    */
    public enum AppListByOrganization {
        ...
        public static let service = APIService<Response>(id: "app-list-by-organization", tag: "application", method: "GET", path: "/organizations/{org-slug}/apps", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(orgSlug: String, sortBy: SortBy? = nil, next: String? = nil, limit: Int? = nil) {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppListByOrganization.service)
            }

            /// convenience initialiser so an Option doesn't have to be created
            public convenience init(orgSlug: String, sortBy: SortBy? = nil, next: String? = nil, limit: Int? = nil) {
                let options = Options(orgSlug: orgSlug, sortBy: sortBy, next: next, limit: limit)
