...
extension Bitrise.Application {
    ...
    */
    public enum AppShow {
        ...
        public static let service = APIService<Response>(id: "app-show", tag: "application", method: "GET", path: "/apps/{app-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppShow.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0AppShowResponseModel

            /** OK */
            case status200(V0AppShowResponseModel)
            ...
            public var success: V0AppShowResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppShowResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppShowResponseModel.self, from: data))
