    ...
    */
    public enum BuildCertificateCreate {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0BuildCertificateUploadParams) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** Created */
            case status201(V0BuildCertificateResponseModel)
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 201: self = try .status201(decoder.decode(V0BuildCertificateResponseModel.self, from: data))
