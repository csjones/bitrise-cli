...
extension Bitrise.BuildCertificate {
    ...
    */
    public enum BuildCertificateDelete {
        ...
        public static let service = APIService<Response>(id: "build-certificate-delete", tag: "build-certificate", method: "DELETE", path: "/apps/{app-slug}/build-certificates/{build-certificate-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildCertificateDelete.service)
            }
