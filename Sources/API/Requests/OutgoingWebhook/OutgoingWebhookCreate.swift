...
extension Bitrise.OutgoingWebhook {
    ...
    */
    public enum OutgoingWebhookCreate {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0AppWebhookCreateParams) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0AppWebhookCreatedResponseModel)
            ...
            public var success: V0AppWebhookCreatedResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppWebhookCreatedResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppWebhookCreatedResponseModel.self, from: data))
