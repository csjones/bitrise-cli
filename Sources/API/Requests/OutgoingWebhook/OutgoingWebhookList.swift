    ...
    */
    public enum OutgoingWebhookList {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0AppWebhookListResponseModel

            /** OK */
            case status200(V0AppWebhookListResponseModel)
            ...
            public var success: V0AppWebhookListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppWebhookListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppWebhookListResponseModel.self, from: data))
