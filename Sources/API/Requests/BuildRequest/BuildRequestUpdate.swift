...
extension Bitrise.BuildRequest {
    ...
    */
    public enum BuildRequestUpdate {
        ...
        public static let service = APIService<Response>(id: "build-request-update", tag: "build-request", method: "PATCH", path: "/apps/{app-slug}/build-requests/{build-request-slug}", hasBody: true, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public struct Options {
                ...
                public init(appSlug: String, buildRequestSlug: String) {
            ...
            public convenience init(appSlug: String, buildRequestSlug: String, body: V0BuildRequestUpdateParams) {
                let options = Options(appSlug: appSlug, buildRequestSlug: buildRequestSlug)
                self.init(body: body, options: options)
            }

            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "app-slug" + "}", with: "\(self.options.appSlug)").replacingOccurrences(of: "{" + "build-request-slug" + "}", with: "\(self.options.buildRequestSlug)")
            }
        }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0BuildRequestUpdateResponseModel)
            ...
            public var success: V0BuildRequestUpdateResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BuildRequestUpdateResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BuildRequestUpdateResponseModel.self, from: data))
