...
extension Bitrise.BuildRequest {
    ...
    */
    public enum BuildRequestList {
        ...
        public static let service = APIService<Response>(id: "build-request-list", tag: "build-request", method: "GET", path: "/apps/{app-slug}/build-requests", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildRequestList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0BuildRequestListResponseModel

            /** OK */
            case status200(V0BuildRequestListResponseModel)
            ...
            public var success: V0BuildRequestListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BuildRequestListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BuildRequestListResponseModel.self, from: data))
