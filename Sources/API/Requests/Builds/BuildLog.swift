    ...
    */
    public enum BuildLog {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0BuildLogInfoResponseModel

            /** OK */
            case status200(V0BuildLogInfoResponseModel)
            ...
            public var success: V0BuildLogInfoResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BuildLogInfoResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BuildLogInfoResponseModel.self, from: data))
