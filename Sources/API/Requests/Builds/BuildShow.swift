...
extension Bitrise.Builds {
    ...
    */
    public enum BuildShow {
        ...
        public static let service = APIService<Response>(id: "build-show", tag: "builds", method: "GET", path: "/apps/{app-slug}/builds/{build-slug}", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildShow.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0BuildShowResponseModel

            /** OK */
            case status200(V0BuildShowResponseModel)
            ...
            public var success: V0BuildShowResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BuildShowResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BuildShowResponseModel.self, from: data))
