...
extension Bitrise.Builds {
    ...
    */
    public enum BuildBitriseYmlShow {
        ...
        public static let service = APIService<Response>(id: "build-bitrise-yml-show", tag: "builds", method: "GET", path: "/apps/{app-slug}/builds/{build-slug}/bitrise.yml", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildBitriseYmlShow.service)
            }
