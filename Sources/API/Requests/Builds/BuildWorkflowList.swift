...
extension Bitrise.Builds {
    ...
    */
    public enum BuildWorkflowList {
        ...
        public static let service = APIService<Response>(id: "build-workflow-list", tag: "builds", method: "GET", path: "/apps/{app-slug}/build-workflows", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: BuildWorkflowList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0BuildWorkflowListResponseModel

            /** OK */
            case status200(V0BuildWorkflowListResponseModel)
            ...
            public var success: V0BuildWorkflowListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0BuildWorkflowListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0BuildWorkflowListResponseModel.self, from: data))
