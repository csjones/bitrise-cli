...
extension Bitrise.AndroidKeystoreFile {
    ...
    */
    public enum AndroidKeystoreFileList {
        ...
        public static let service = APIService<Response>(id: "android-keystore-file-list", tag: "android-keystore-file", method: "GET", path: "/apps/{app-slug}/android-keystore-files", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AndroidKeystoreFileList.service)
            }
