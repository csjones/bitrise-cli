...
extension Bitrise.AppSetup {
    ...
    */
    public enum AppFinish {
        ...
        public static let service = APIService<Response>(id: "app-finish", tag: "app-setup", method: "POST", path: "/apps/{app-slug}/finish", hasBody: true, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0AppFinishParams) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0AppFinishRespModel)
            ...
            public var success: V0AppFinishRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppFinishRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppFinishRespModel.self, from: data))
