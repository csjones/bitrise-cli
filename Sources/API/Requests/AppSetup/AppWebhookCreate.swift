...
extension Bitrise.AppSetup {
    ...
    */
    public enum AppWebhookCreate {
        ...
        public static let service = APIService<Response>(id: "app-webhook-create", tag: "app-setup", method: "POST", path: "/apps/{app-slug}/register-webhook", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AppWebhookCreate.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0WebhookRespModel

            /** OK */
            case status200(V0WebhookRespModel)
            ...
            public var success: V0WebhookRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0WebhookRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0WebhookRespModel.self, from: data))
