...
extension Bitrise.AppSetup {
    ...
    */
    public enum SshKeyCreate {
        ...
        public static let service = APIService<Response>(id: "ssh-key-create", tag: "app-setup", method: "POST", path: "/apps/{app-slug}/register-ssh-key", hasBody: true, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0SSHKeyUploadParams) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0SSHKeyRespModel)
            ...
            public var success: V0SSHKeyRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0SSHKeyRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0SSHKeyRespModel.self, from: data))
