...
extension Bitrise.AppSetup {
    ...
    public enum AppConfigCreate {
        ...
        public static let service = APIService<Response>(id: "app-config-create", tag: "app-setup", method: "POST", path: "/apps/{app-slug}/bitrise.yml", hasBody: true, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public convenience init(appSlug: String, body: V0AppConfigRequestParam) {
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            /** OK */
            case status200(V0AppConfigRespModel)
            ...
            public var success: V0AppConfigRespModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0AppConfigRespModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0AppConfigRespModel.self, from: data))
