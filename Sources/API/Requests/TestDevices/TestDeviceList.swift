...
extension Bitrise.TestDevices {
    ...
    */
    public enum TestDeviceList {
        ...
        public static let service = APIService<Response>(id: "test-device-list", tag: "test-devices", method: "GET", path: "/apps/{app-slug}/test-devices", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: TestDeviceList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0TestDeviceListResponseModel

            /** OK */
            case status200(V0TestDeviceListResponseModel)
            ...
            public var success: V0TestDeviceListResponseModel? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0TestDeviceListResponseModel, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0TestDeviceListResponseModel.self, from: data))
