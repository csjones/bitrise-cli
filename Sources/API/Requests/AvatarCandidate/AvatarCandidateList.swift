...
extension Bitrise.AvatarCandidate {
    ...
    */
    public enum AvatarCandidateList {

        public static let service = APIService<Response>(id: "avatar-candidate-list", tag: "avatar-candidate", method: "GET", path: "/v0.1/apps/{app-slug}/avatar-candidates", hasBody: false, securityRequirement: SecurityRequirement(type: "PersonalAccessToken", scopes: []))
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: AvatarCandidateList.service)
            }
        ...
        public enum Response: APIResponseValue, SingleFailureType, CustomStringConvertible, CustomDebugStringConvertible {
            public typealias SuccessType = V0FindAvatarCandidateResponse

            /** OK */
            case status200(V0FindAvatarCandidateResponse)
            ...
            public var success: V0FindAvatarCandidateResponse? {
                switch self {
            ...
            public var responseResult: APIResponseResult<V0FindAvatarCandidateResponse, ServiceStandardErrorRespModel> {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 200: self = try .status200(decoder.decode(V0FindAvatarCandidateResponse.self, from: data))
